<?php
namespace ShopBonsai\CustomShipping\Model\Carrier;
    ...
    \Magento\Shipping\Model\Carrier\CarrierInterface
{
     ...
     * @var string
     */
    protected $_code = 'shopbonsaishipping';
    ...
    public function collectRates(RateRequest $request)
    {
        ...
        if ($shippingPrice !== false) {
            ...
            $method->setCarrier('shopbonsaishipping');
            $method->setCarrierTitle($this->getConfigData('title'));

            $method->setMethod('shopbonsaishipping');
